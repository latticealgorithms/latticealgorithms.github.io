...
1. What does it take to believe that no efficient algorithm exists for a computational problem?
...
1. Why does [[https://latticechallenge.org][latticechallenge.org]] only have $q$ = prime and the power-of-two case?
